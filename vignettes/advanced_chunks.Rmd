...
When chunks containers have un-evaluated code, these un-evaluated code will not block any merging operations as explained above. But if they are evaluated, then their environment will be updated and will reflect the intended state of the chunks container as described by the code expressions.
