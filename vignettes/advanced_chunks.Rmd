...
teal.code::chunks_push(chunks = ch_plot, x = quote(foo_plot(df)))
...
teal.code::chunks_push(chunks = ch_table, x = quote(foo_print(df)))
...
teal.code::chunks_push(chunks = ch_ouput, x = quote(foo_plot(df)))
teal.code::chunks_push(chunks = ch_ouput, x = quote(foo_print(df)))
