...
server <- function(input, output, session) {
  ...
  # The ability to put this process in its own chunks container, independent of the rest, allows the app to avoid re-computation
  # and yet be able to capture its code to ensure reproducibility.
