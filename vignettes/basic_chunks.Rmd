...
A quoted R expression can simply be evaluated with the `base::eval` function as demonstrated above. But additional functionalities are needed for the `chunks` container to work. Here are some additional methods, besides `eval`, that the `chunk` object contains:
